      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        >
          ...
          <p className="text-gray-600">
            To become the best security risk management company in Nigeria using innovative interventions.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-gray-600">
            To democratize peace of mind in Nigeria, leveraging technology and offer power to live safely.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-gray-600">
           Excellence, professionalism, integrity, care.
          </p>
        </div>
      </div>
    </div>
